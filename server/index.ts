...
import { publicTeamMembers, adminTeamMembers } from './routes/teamMembers.js';
import { memberPods, adminPods } from './routes/pods.js';
...
app.use('/api/team-members', publicTeamMembers);
app.use('/api/admin/team-members', adminTeamMembers);
app.use('/api/pod', memberPods);
app.use('/api/admin/pods', adminPods);
