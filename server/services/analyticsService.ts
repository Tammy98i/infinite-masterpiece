...
export const ALLOWED_EVENTS = [
  ...
  'course_view',
  'course_chapter_selected',
  'course_chapter_progress_25',
  'course_chapter_progress_50',
  'course_chapter_progress_75',
  'course_locked_chapter_click',
  'course_access_dialog_view',
  'course_primary_cta_click',
  'resume_click',
  'content_card_click',
  'hero_play_click',
  'hero_details_click',
  ...
  'pod_task_stuck',
  'pod_question_asked',
  'pod_question_answered',
  'pod_created',
  'pod_captain_changed',
  'pod_closed',
  'add_to_calendar_clicked',
  'whatsapp_group_clicked',
  'brave_track_interest_clicked',
  'hesitant_track_interest_clicked',
  'pilot_cta_clicked',
