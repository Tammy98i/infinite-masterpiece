...
תגובות · שאלות למרצה · AI · gamification · אפליקציה · מייל/וואטסאפ אוטומטי · Revenue Share

Pods בבנייה לפי [`SPEC-PODS.md`](./SPEC-PODS.md), מחוץ לשלושת שבועות ההשקה הקריטיים. מייל/וואטסאפ של הפוד נשארים שלב 2.
