...
export function WebinarNeuralHero({
  ...
  return (
    <section ref={rootRef} id="webinar-hero" className="webinar-stage-hero webinar-neural-hero is-slim" dir="rtl">
      <video
        ref={videoRef}
      ...
      <div className="webinar-stage-shell">
        <div className="webinar-stage-copy">
          ...
          {eventEnded ? <p className="webinar-neural-note">{WEBINAR_CTA_ENDED}</p> : null}
          {primary}
        </div>
      </div>
    </section>
