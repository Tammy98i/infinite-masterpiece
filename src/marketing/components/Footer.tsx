...
export function Footer() {
  return (
    <footer
      className="relative bg-[#010308]/78 backdrop-blur-xl overflow-hidden pt-20 pb-12 border-t border-white/[0.08]"
      role="contentinfo"
    ...
    >
      <div className="relative z-10 max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10 text-right mb-16">
          <div>
            ...
            <ul className="space-y-3 text-sm text-white/50 font-light">
              <li>
                <a href="/#what-is-it" className="hover:text-white transition-colors">
                  במה זה שונה
                </a>
              </li>
              <li>
              ...
              <li>
                <Link to="/hesitation" className="hover:text-white transition-colors">
                  מסלול ההססנים
                </Link>
              </li>
            </ul>
          ...
          <div>
            <h3 className="text-[11px] uppercase tracking-[0.2em] text-[#C8A24C] mb-4">המיזם</h3>
            <ul className="space-y-3 text-sm text-white/50 font-light">
              <li>
                <a href="/#depth-layer" className="hover:text-white transition-colors">
                  מהי שכבת העומק
                </a>
              </li>
              <li>
              ...
              <li>
                <Link to="/application?type=88" className="hover:text-white transition-colors">
                  הגשת מועמדות
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-white/50 font-light">
              <li>
                <Link to="/library-membership" className="hover:text-white transition-colors">
                  מנוי ספרייה
                </Link>
              </li>
              <li>
              ...
              <li>
                <a href="/#infinite-library" className="hover:text-white transition-colors">
                  הפלטפורמה
                </a>
              </li>
            </ul>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 pt-8 border-t border-white/[0.05]">
          ...
          <Link to="/#pricing" className="text-sm text-[#C8A24C] hover:text-[#F7E7B5] transition-colors">
            להצטרפות למסע
          </Link>
        </div>
      </div>
