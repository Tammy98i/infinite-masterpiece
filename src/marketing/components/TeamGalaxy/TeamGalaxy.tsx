...
import { teamGalaxyPublicMembers } from '../../../constants/teamGalaxySeed';
...
export function TeamGalaxy() {
  ...
  useEffect(() => {
    teamMembersApi
      .list()
      .then((list) => setMembers(list.length ? list : teamGalaxyPublicMembers()))
      .catch(() => {
        setMembers(teamGalaxyPublicMembers());
      });
  }, []);
