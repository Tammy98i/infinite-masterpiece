  ...
  const renderStudentDashboard = (isPremium: boolean) => (
    <>
      ...
      <motion.div 
        ...
        className="relative bg-gradient-to-r from-[#b79043]/15 to-transparent border border-[#b79043]/20 rounded-[32px] p-8 md:p-12 mb-12 overflow-hidden group"
      >
        ...
        <div className="relative z-10 flex flex-col md:flex-row gap-8 justify-between items-start md:items-center">
          ...
          <div className="w-full md:w-auto flex flex-col gap-4">
            ...
            {isPremium && (
              <div className="bg-[#b79043]/10 backdrop-blur-md rounded-2xl p-6 border border-[#b79043]/20">
