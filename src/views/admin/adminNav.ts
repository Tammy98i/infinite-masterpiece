...
export const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'team-galaxy', label: 'שקופית הצוות', ready: true, icon: Sparkles, badge: 'חדש', keywords: 'galaxy team webinar אנשים מנחים' },
...
> = {
  ...
  'team-galaxy': { title: 'שקופית הצוות', description: 'אנשי צוות, אנשי מפתח ומנחי הוובינר — אותה רשימה לדסקטופ ולמובייל', group: 'אנשים והרשאות' },
  ...
  webinar: { title: 'וובינר', description: 'תאריך, מנחים, צוות, הרשמות ומדדים', group: 'מסחר והכנסות' },
