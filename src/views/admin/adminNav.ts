...
export const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'team-galaxy', label: 'גלקסיית הצוות', ready: true, icon: Sparkles, badge: 'חדש', keywords: 'galaxy team stars impact' },
...
> = {
  ...
  'team-galaxy': { title: 'גלקסיית הצוות', description: 'ניהול אנשי צוות, Impact Score ותצוגת הגלקסיה', group: 'אנשים והרשאות' },
