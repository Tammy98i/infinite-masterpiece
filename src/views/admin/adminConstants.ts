...
export const fieldClass =
  'w-full bg-[rgba(5,10,20,.55)] border border-white/10 rounded p-2 text-sm text-white placeholder:text-white/30 focus:border-white/40 focus:outline-none min-h-11 disabled:cursor-not-allowed disabled:opacity-55';
