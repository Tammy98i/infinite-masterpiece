    ...
    <div className="library-catalog-page min-h-screen text-white pt-28 pb-24 px-4 sm:px-8 max-w-7xl mx-auto text-right">
      ...
      <div className="grid gap-12">
        {learningPaths.map((path) => {
          ...
          return (
            <div key={path.id} className="library-page-hero p-6 sm:p-10 border relative overflow-hidden">
              
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center mb-8 border-b border-white/10 pb-8">
                <div className="lg:col-span-8">
                  <div className="flex items-center gap-3 mb-2">
                    <span className="px-3 py-1 rounded-[4px] bg-white text-[#141414] font-semibold text-xs">
                ...
                <div className="lg:col-span-4 flex justify-end">
                  <button
                    ...
                    className="library-hero-play w-full sm:w-auto px-8 py-4 text-base font-semibold flex items-center justify-center gap-2"
                  >
