...
export const ENTRY_TRACK_FINE_PRINT =
  `הבהרה: מסלול ההססנים אינו הנחה ואינו מסלול חלקי. במסלול ההססנים ניתנת גישה מלאה למיזם ולספרייה. סך התשלום במסלול ההססנים הוא ${formatIls(8888)} לפני מע״מ, בפריסה של 4 פעימות: ${formatIls(8)} במעמד ההרשמה, ${formatIls(80)} במוצאי שבת לפני השבוע השני, ${formatIls(800)} במוצאי שבת לפני השבוע השלישי, ו־${formatIls(8000)} במוצאי שבת לפני השבוע הרביעי. מסלול האמיצים הוא תשלום מלא של ${formatIls(8008)} לפני מע״מ. משתתפי מסלול האמיצים מקבלים 2 כרטיסי כניסה לכל הגרלה. משתתפי מסלול ההססנים מקבלים כרטיס כניסה אחד לכל הגרלה. תנאי ההגרלות, הזכאות והמימוש יופיעו בתקנון.`;
