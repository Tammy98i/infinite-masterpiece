export const WEBINAR_PUNCHLINE = 'לא עוד השראה. תנועה. מערכת. פרנסה. אינסוף.';
...
export const WEBINAR_DIFFERENCE_POINTS = [
  {
    ...
    text: 'לא לחץ. לא מניפולציה. אבחון, בהירות, ערך וצעד הבא.',
  },
  {
    title: 'משימת ביצוע בזמן אמת',
    text: 'תוצר אחד. אדם אחד. פעולה אחת שנשלחת לעולם.',
  },
  {
    title: 'הזמנה לפיילוט הראשון',
    text: 'מסע של 33 ימים למי שמתאים ורוצה להמשיך.',
  },
] as const;
...
export const WEBINAR_TIMELINE = [
  ...
  },
  {
    ...
    text: 'לא “איך לסגור בכוח”, אלא איך לאבחן, להבין, לשאול, לבנות אמון ולייצר החלטה.',
  },
  {
  ...
  },
  {
    ...
    text: 'אמיצים / הססנים — שתי דרכי כניסה לפיילוט.',
  },
  {
    title: 'Q&A והצעד הבא',
...
export const WEBINAR_ECOSYSTEM = [
  ...
  { title: 'ספריית אינסוף', text: 'שכבת תוכן בתוך האקו־סיסטם — לא מנוי נפרד בוובינר הזה.' },
...
export const WEBINAR_PILOT_DAYS = [
  ...
  { title: 'ימים 1–8', text: 'מכירות, השפעה, שיחה, Follow-up ומשא ומתן.' },
  { title: 'ימים 9–16', text: 'שיווק, מיתוג, בידול, תוכן וערוצים.' },
  { title: 'ימים 17–24', text: 'מוצר, תמחור, CRM, תפעול וטכנולוגיה.' },
  { title: 'ימים 25–32', text: 'פיננסים, זכויות, קהילה ושותפויות.' },
...
export const WEBINAR_TRACKS_FINE_PRINT =
  'הסליקה, מועדי הפעימות, זכות הביטול והאחריות המחייבת יופיעו במסמכי ההרשמה הסופיים. מסלול ההססנים הוא אותו יעד בפריסה — לא הנחה ולא מוצר חלקי.';
