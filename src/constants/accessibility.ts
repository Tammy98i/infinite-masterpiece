...
export const A11Y_LAST_AUDIT_DATE = pick(import.meta.env.VITE_A11Y_LAST_AUDIT_DATE, '25 בספטמבר 2026');
export const A11Y_STATEMENT_UPDATED = pick(import.meta.env.VITE_A11Y_STATEMENT_UPDATED, '25 בספטמבר 2026');
