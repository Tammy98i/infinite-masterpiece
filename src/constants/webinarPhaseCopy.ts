...
export function webinarCopy(phase: WebinarPhase) {
  if (phase === 'ended') {
    return {
      ...
      hostsLead: 'גל, תמי וגלב הובילו את המחזור החי. השיטה נשארת: בהירות, הצעה, פעולה.',
      hostsLabel: 'המנחים',
  ...
  if (phase === 'live') {
    return {
      ...
      heroSubheadline: '',
      heroMicro: '',
      hostsLead: 'גל, תמי וגלב בלייב עכשיו. שיעור מכירות, משימת ביצוע, ואז פעולה שנשלחת לעולם.',
      hostsLabel: 'הערב החי',
      stepsTitle: 'מה תצאו איתו מהערב',
  ...
  return {
    ...
    heroSubheadline: '',
    heroMicro: '',
    hostsLead: 'גל, תמי וגלב בלייב. שיעור מכירות, משימת ביצוע, ואז פעולה שנשלחת לעולם.',
    hostsLabel: 'המנחים',
    stepsTitle: 'מה תצאו איתו מהערב',
    footerRegister: 'הרשמה',
    registerAria: 'הרשמה לוובינר',
