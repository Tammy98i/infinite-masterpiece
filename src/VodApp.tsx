...
export const VodApp: React.FC = () => {
  ...
  return (
    ...
    <div className={`vod-app library-catalog sky-readable flex flex-col min-h-screen relative text-white bg-transparent${currentView === 'admin' || currentView === 'lecturer' || currentView === 'profile' ? ' crm-desk' : ''}`}>
      ...
      {currentView !== 'watch' && (
        <footer className="editorial-library-footer library-bottom-clearance relative z-10 border-t border-white/10 pt-10 px-4 sm:px-8 lg:px-10 text-start select-none" role="contentinfo" aria-label="תחתית הספרייה">
