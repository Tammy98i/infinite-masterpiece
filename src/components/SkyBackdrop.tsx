...
export function SkyBackdrop({ className = '' }: Props) {
  return (
    <div className={`editorial-sky-backdrop fixed inset-0 z-0 pointer-events-none overflow-hidden ${className}`} aria-hidden="true">
      ...
      <div className="editorial-sky-library-veil editorial-sky-library-veil-i absolute inset-0" />
      <div className="editorial-sky-library-veil editorial-sky-library-veil-j absolute inset-0" />
      <div className="editorial-sky-library-veil editorial-sky-library-veil-k absolute inset-0" />
      <div className="editorial-sky-depth-veil editorial-sky-depth-veil-a absolute inset-0" />
      <div className="editorial-sky-depth-veil editorial-sky-depth-veil-b absolute inset-0" />
      <div className="editorial-sky-depth-veil editorial-sky-depth-veil-c absolute inset-0" />
