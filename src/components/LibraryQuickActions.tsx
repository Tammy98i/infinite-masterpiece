...
export function LibraryQuickActions() {
  ...
  return <section aria-labelledby="quick-actions-heading" className="library-spacious-section px-4 py-10 sm:px-8 lg:px-10">
    <div className="mx-auto max-w-[1400px]">
      ...
      <div className="grid grid-cols-2 gap-3 lg:grid-cols-4">{ACTIONS.map(item => <button key={item.view} type="button" onClick={() => setView(item.view)} className="group flex min-h-24 items-center gap-3 rounded-2xl border border-white/10 bg-[#0d0b08]/65 p-4 text-right transition-colors hover:border-[#b79043]/45 hover:bg-[#b79043]/5 focus-visible:ring-2 focus-visible:ring-[#b79043]">
