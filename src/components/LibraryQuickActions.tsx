...
export function LibraryQuickActions() {
  ...
  return <section aria-labelledby="quick-actions-heading" className="library-spacious-section library-island px-4 py-3 sm:px-8 lg:px-10">
    <div className="mx-auto max-w-[1400px]">
      ...
      <div className="grid grid-cols-2 gap-2 lg:grid-cols-4">{ACTIONS.map(item => <button key={item.view} type="button" onClick={() => setView(item.view)} className="library-quick-action group flex min-h-14 cursor-pointer items-center gap-3 border border-white/10 p-3 text-start transition-colors hover:bg-white/5 focus-visible:ring-2 focus-visible:ring-[#b79043]">
