...
export const HeroBanner: React.FC<HeroBannerProps> = ({ course, continueWatching }) => {
  ...
  return (
    <section
      className="library-hero relative w-full flex items-end overflow-hidden pt-24"
    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-8 w-full z-10 text-start md:max-w-2xl md:ms-0 md:me-auto">
        ...
        <h1 className="text-3xl sm:text-5xl lg:text-[4.25rem] font-semibold text-white leading-[1.08] tracking-tight mb-3 sm:mb-4">
          {course.title}
        </h1>
